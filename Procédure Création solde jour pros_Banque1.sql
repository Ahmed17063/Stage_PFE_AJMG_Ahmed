Drop procedure if exists calcul_sfj_pros;
DELIMITER $
CREATE PROCEDURE calcul_sfj_pros()
	BEGIN
		...
		from mvts_jours_pros; -- table de travail
        
        Select SFM INTO current_sfj
		from mvts_jours_pros
		where id=1;
		...
		While compteur < max_id DO
            ...
            insert into mvts_jours_pros2 value (id_v1, compte_v1, COPRO_v1, date_val_v1, summontant_v1, Auto_decouv_v1, SFM_v1, SFJ_v1, NBJ_v1, Decouvert_v1, Decouvert_id_v1, Depassement_v1, Depassement_id_v1);
